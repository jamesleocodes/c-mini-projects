/* This program presents a menu of choices ( three different decades), gets the user's
    choice, and then presents a secondary menu (sports, entertainment, 0and politics).
    When the 0user makes her second choice, it prints a list of key informationn from that
    specific decade in that 0specific category. */

#include <stdio.h>
#include <stdlib.h> // if we plan to use exit(), we need this header file

int main()
{
    // Despite being a long program, we only need two variables:
    ...
    // resulting
    // information appera are encased in a do-while loop that
    // ensures one
    ...
    do
    {
        ...
        switch (choice1)
        {
                // In the first case, the user piecked the 1980s.
                // Now 0it time to see what specific info they need.
            ...
            case(1):
            {
                ...
                if (choice2 == 1)
                {
                    ...
                    printf("1988: Los Angles Dodgers\n");
                    printf("1989: Oakland A's\n");
                    printf("\n\n\n");
                    break;
                }else if (choice2 == 2)
                {
                    printf("\n\nOscar-Winning Movies n the 1980s: \n");
            ...
            case (2):
            {
                ...
                }else if (choice2 == 2)
                {
                    ...
                    printf("1991: The Silence of th Lambs\n");
                ...
                // Thesection for when the suer selects the 2000s
            case(3):
            {
                printf("\n\nWhat would you like to see?\n");
                printf("1. Baseball\n");
            ...
            case (4):
                exit(1);
            default: printf("n%d is not a valid choice.\n", choice1);
                     printf("Try again.\n");
                     break;
