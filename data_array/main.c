/* This program creates an array of 10 game scores for a basketball player.
 The scores from the first six games are in program and the scores from the last
 four are inputted by the user. */
...
int main()
{
    ...
    // Now that you have 10 scores, loop through the scores
