/* THis program rolls two dice and presents the total. It then asks the user to
 guess if the next total will be higher, lower, or equal. It then rolls two more
 dice and tells the user how they did. */
...
int main()
{
    int dice1, dice2;
    int total1,total2;
    time_t t; //time declaration to set truly random number
    char ans;
