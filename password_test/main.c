/* This program asks a user for a username and a password. It test
    whether their passwrod has an uppercase letter, lowercase letter,
...
int main()
{
    ...
    /* The if protion will only excute if all three variables below are 1, and the variables will only equal 1 if the appropriate characters were each found */
    ...
    } else
    {
        ...
        printf("One that uses upper and lowercae letters ");
        printf("and a number. ");
    }
    return(0);
}
