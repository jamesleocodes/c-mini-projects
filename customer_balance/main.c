/* This program takes an ID number from the user and then checks the
 ID against a list of customers in the database. If the curstomer
 exits, it uses that array element to check their current balance,
...
int main()
{
    ...
    // Define the 10 elements in the two parallel arrays
    ...
    /* Search to see that the customer ID exist in the array */
