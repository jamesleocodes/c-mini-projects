/* This program will ask users how many movies they've seen this year and loop through asking the same of each movie and a rating from 1 to 10. It will remember their favorite movie and their least favorite movie. */
...
int main()
{
    ...
    // 1 or higher will replace it and the leatRating to 10 so any
    // movie reated 9 or lower will replace it.
    ...
    {
        // Get the name of the movies and the users's rating
        ...
        // Check whether it's their worse-rated movie so far
    ...
    printf("\nYour Least-favoite Movie was %s.\n", least);
