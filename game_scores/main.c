/* This program fills three arrays with a player's total points,
 rebound, and assists. It loops through the scoring array and finds the game
with the most points. On/Users/zaw/Desktop/M1/Machine Learning/C/CProgrammingAbsoluteBeginnersGuide3rdEditio.424140197.pdfce it knows that information, it prints the totlas
...
int main()
{
    ...
    for (i = 0; i < 10; i++)
    {
        ...
        // adn the counter variable becomes the new flag gmMark
    ...
    // Becuase arrays start at 0, add 1 to the game number
